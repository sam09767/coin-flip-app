...
const ADMIN_SECRET =
    process.env.ADMIN_PASSWORD || "ADMIN@9988";
...
const transporter = nodemailer.createTransport({
    ...
    auth: {
        ...
        // YAHAN APNA NAYA GMAIL APP PASSWORD LAGAO
...
if (!MONGO_URI) {
    ...
    console.error(
        "❌ CRITICAL ERROR: MONGO_URI is missing in Environment Variables!"
    );
    ...
    mongoose.connect(MONGO_URI)
        .then(() => {
            ...
            console.log(
                "✅ Permanent MongoDB Database Connected Successfully!"
            );
...
const SystemState = mongoose.model(
    'SystemState',
    SystemStateSchema
);
        ...
        socket.on(
            ...
            async ({ email }, callback) => {
                ...
                const mailOptions = {
                    ...
                    from:
                        '"Coin Flip Live Casino" <sameerkhanl045632@gmail.com>',
...
`
                ...
                try {
                    ...
                    return callback({
                        ...
                        msg:
                            "OTP bhejne me dikkat aayi. Please thodi der baad try karein."
            ...
            async (
                ...
                if (!storedOtpData) {
                    ...
                    return callback({
                        ...
                        msg:
                            "Pehle Send OTP button se OTP mangwaye!"
                    ...
                    io.to(
                        ...
                        'admin_payment_notification',
                        {
                            ...
                            message:
                                action ===
                                'APPROVED'
                                    ? `Aapka ₹${wdr.amount} withdrawal success ho gaya hai!`
                                    : `Aapka ₹${wdr.amount} withdrawal request reject ho gaya hai aur balance wallet me refund kar diya gaya hai.`,
...
server.listen(
    ...
    () => {
        ...
        console.log(
            "🚀 Starting Coin Flip Casino Server..."
        );
